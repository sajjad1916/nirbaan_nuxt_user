    ...
    <nav class="2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
      ...
      <div class="flex justify-between">
        ...
        <div class="flex space-x-3 items-center">
          <img
            class="w-20"
            src="https://www.nirbaanexpress.com/image/nirbaanlogo.png"
            alt="circle"
          />
          <nuxt-link
            to="/"
            class="
              ...
              text-gray-800
            "
            >Nirbaan Express</nuxt-link
          >
        </div>

<div v-if="loggedIn" class="hidden sm:flex flex-row space-x-4">
          <nuxt-link
            to="/dashboard"
            class="
              rounded-md
        ...
        <div v-else class="hidden sm:flex flex-row space-x-4">
          <nuxt-link
            to="/signup"
            class="
              rounded-md
      ...
      <div id="MobileNavigation" class="hidden sm:hidden mt-4 mx-auto">
        ...
        <div v-if="loggedIn" class="flex flex-col gap-4 mt-4 w-80 mx-auto">
          <nuxt-link
            to="/dashboard"
            class="
              rounded-md
        ...
        <div v-else class="flex flex-col gap-4 mt-4 w-80 mx-auto">
          <nuxt-link
            to="/signup"
            class="
              rounded-md
...
export default {
  ...
  methods: {
    login() {
      if (this.$auth.$storage.state.loggedIn) {
        this.loggedIn = true;
      }
    },
    toggleMenu() {
