<template>
  <div>
    ...
    <div class="relative">
      <img
        src="https://cdn.pixabay.com/photo/2021/10/29/11/09/container-6751623_960_720.jpg"
          ...
          <div class="flex flex-col items-center justify-between xl:flex-row">
            <div class="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              >
                ...
                <span class="text-yellow-400">Partner</span>
              </h2>
...
export default {
  auth: false,
  name: "IndexPage",
  components:{Navbar,Services, Faq, Footer,Aboutus, Contact},
  data() {
    return {
      isMenuOpen: false,
    };
